                ...
                <div className="lg:grid lg:grid-cols-3 lg:gap-8">
                  ...
                  <div className="mt-10 lg:mt-0 p-4">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-base leading-6 text-gray-600">
                      ShortGPT is equipped with an advanced asset sourcing module that can retrieve images and video footage from the internet. This feature allows for the easy incorporation of relevant visuals into the content (Pexels,Pixabay, youtube, and more soon).
                      </p>
                    </div>
                  </div>
                </div>
