...
class EditingStep(Enum):
    ...
    ADD_CAPTION_SHORT_TOP = "make_caption_top.json"
    ADD_CAPTION_SHORT_BOTTOM = "make_caption_bottom.json"
    ADD_CAPTION_SHORT_ARABIC_TOP = "make_caption_arabic_top.json"
    ADD_CAPTION_SHORT_ARABIC_BOTTOM = "make_caption_arabic_bottom.json"
    ADD_CAPTION_LANDSCAPE_ARABIC_TOP = "make_caption_arabic_landscape_top.json"
    ADD_CAPTION_LANDSCAPE_ARABIC_BOTTOM = "make_caption_arabic_landscape_bottom.json"
    ADD_CAPTION_LANDSCAPE_TOP = "make_caption_landscape_top.json"
    ADD_CAPTION_LANDSCAPE_BOTTOM = "make_caption_landscape_bottom.json"
